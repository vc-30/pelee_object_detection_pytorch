...
# checkpoint = 'checkpoint_pelee304.pth.tar'
...
# Transforms
resize = transforms.Resize((304, 304))
...
if __name__ == '__main__':
    ...
    for file_name in files:
        ...
        out_file_name = os.path.join(out_dir, file_name.split(".")[0]+"_out.png")
        detect(original_image, min_score=0.5, max_overlap=0.5, top_k=200).save(out_file_name)
